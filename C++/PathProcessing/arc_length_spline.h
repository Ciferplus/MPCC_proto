...
#ifndef PATH_PROCESSING_ARC_LENGTH_SPLINE_H
#define PATH_PROCESSING_ARC_LENGTH_SPLINE_H
...
public:
    ...
    double projectOnSpline(const SimpleState &state) const;

    ArcLengthSpline();
    ArcLengthSpline(const SplineParams &params);

    void setParams(const SplineParams &params) { params_ = params; }
...
#endif  // PATH_PROCESSING_ARC_LENGTH_SPLINE_H
