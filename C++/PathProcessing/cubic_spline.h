...
#ifndef PATH_PROCESSING_CUBIC_SPLINE_H
#define PATH_PROCESSING_CUBIC_SPLINE_H
...
private:
    ...
    CubicSplineParams spline_params_;
    CubicSplineData spline_data_;
};

}  // namespace path_processing
}  // namespace mpcc

#endif  // PATH_PROCESSING_CUBIC_SPLINE_H
